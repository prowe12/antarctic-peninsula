...
Purpose: Get cloud forcing at Escudero for 2017-2023
...
# Date range
# date1 = dt.datetime(2019, 10, 3, 0, 0, tzinfo=pytz.utc)
# date2 = dt.datetime(2019, 12, 31, 23, 59, tzinfo=pytz.utc)

date1 = dt.datetime(2017, 1, 1, 0, 0, tzinfo=pytz.utc)
date2 = dt.datetime(2017, 12, 31, 23, 59, tzinfo=pytz.utc)
...
# A6) Get Escudero met data from web (note that additional code besides the
#     following was run)
# for month in range(date1.month, date2.month + 1):
#     dtime = dt.datetime(date1.year, month, 1)
#     get_met_15_minutes(
#         atm_prof_params.FREI_MET_STATION, dtime, atm_prof_params.FREI_MET_DIR
#     )
# # get_met(
# #     date1.year,
# #     met_params.DIREC_BY_MINUTE + str(date1.year) + "/",
# #     met_params.STATION,
# #     met_params.PFIX,
# #     met_params.EXT,
# # )
...
get_atm_profs(atm_prof_params, lat, lon, date1, date2, REDO)
